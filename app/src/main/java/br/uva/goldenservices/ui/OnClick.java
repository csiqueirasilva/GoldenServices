...
public class OnClick {
    ...
    public static void fillOnClickCallbacks() {
        ...
        callbacks.put(R.id.listTrabalhoTituloAnuncio, new OnClickCallback() {
            @Override
            public void onClick(View v) {
        ...
        callbacks.put(R.id.listTrabalhoNegar, new OnClickCallback() {
            @Override
            public void onClick(View v) {
                Long idTrabalho = (Long) v.getTag();
                TrabalhoView.negarTrabalho(idTrabalho);
            }
        });
